...
export function PackPage({ userId }: PackPageProps) {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto space-y-6">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold ro-title mb-2">Open Card Packs</h1>
        <p className="text-muted-foreground">Try your luck and collect rare cards!</p>
      </div>

      <PackOpening userId={userId} onPackOpened={loadCollection} />
